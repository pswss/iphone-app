...
final class AppLanguage {
    ...
    static let en: [String: String] = [
        ...
        "메모 검색": "Search notes",
        "알림음": "Alert Sound",
        "커스텀 알림음 사용 중": "Custom alert sound in use",
        "기본 알림음": "Default alert sound",
        "Oneul의 일정·시험 알림에 쓰여요": "Used for Oneul's event & exam alerts",
        "음원 가져오기": "Import Audio",
        "기본음으로": "Use Default",
        "기본 알림음으로 되돌렸어요": "Reverted to the default sound",
        "미리 듣기": "Preview",
        "정지": "Stop",
        "알림음으로 저장": "Save as Alert",
        "저장했어요 — 다음 알림부터 이 소리로 울려요": "Saved — future alerts will use this sound",
        "저장하지 못했어요": "Couldn't save",
        "파일을 읽지 못했어요": "Couldn't read the file",
        "지원하지 않는 오디오 형식이에요": "Unsupported audio format",
        "초": "s",
        "잘라내기": "Cut",
        "복사": "Copy",
        "복제": "Duplicate",
